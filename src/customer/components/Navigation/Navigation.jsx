      ...
      <div class="bg-white">
        <div class="border py-3 px-6">
          <div class="flex justify-between">
            ...
            <div class="ml-6 flex flex-1 gap-x-3" ref={dropdownRef}>
              <div class="flex cursor-pointer select-none items-center gap-x-2 rounded-md border bg-[#4094F7] py-2 px-4 text-white hover:bg-blue-500" onClick={handleCategoriesClick}>
              ...
              {showDropdown && (
                <div className="absolute mt-1 w-40 bg-white rounded-md shadow-lg z-10">
                  <a
                    ...
                    onClick={() => console.log('Vegetables clicked')}
                  >
                    Vegetables
                  </a>
                  <a
          ...
          <div class="mt-4 flex items-center justify-between">
            ...
            <div class="flex gap-x-8"></div>

            <span class="cursor-pointer rounded-sm py-1 px-2 text-sm font-medium hover:bg-gray-100">Become a seller</span>
          </div>
        </div>
      </div>
    </div>
